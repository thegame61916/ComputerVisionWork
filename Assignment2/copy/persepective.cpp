...
#define IMAGE1	"f.jpg"//"I1.jpg"
#define IMAGE2	"I1.jpg"//"I2.jpg"


double H1[] = {1.08600724e-03,  -1.45412618e-03,   9.41393201e-01};
double H2[] = { 2.80542979e-04,   7.88305923e-05,   3.37300803e-01};
double H3[] = { -5.43929117e-07,  -9.28475703e-08,   1.90565425e-03}; 
...
/*for(int i = 0; i<image1.rows; i++)
	...
	for(int i = 0; i<image2.rows; i++)
	{
		for(int j = 0; j<image2.cols; j++)
		{
			...
			if( w == 0)
				w = 1;
			if(x/w>=0 && y/w>=0 && x/w<image1.cols && y/w< image1.rows)
//cout<<(abs(x/w))<<"\n";
